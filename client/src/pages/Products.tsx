    ...
    <div className="min-h-screen bg-app-cream">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <button
                  ...
                  className="lg:hidden flex items-center gap-2 px-3 py-2 hover:bg-app-cream transition-colors text-sm bg-white rounded-xl border border-app-border"
                >
      ...
      {mobileFiltersOpen && (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white z-50 rounded-t-2xl max-h-[80h] overflow-y-auto animate-slide-in-up">
